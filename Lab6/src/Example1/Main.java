...
// то он определяет значение текстового ноля. Методу аргументом также может
// передаваться символьный массив. Если массив состоит из одного элемента,
// то он определяет значение символьного поля. В противном случае
...
public class Main {
    public static void main(String[] args){
        ...
        int[] numbers2 = new int[] {2,3,4,5,6};

        tion.function(12);
        tion.function("STRING");
        tion.function(numbers1);
        tion.function(numbers2);
